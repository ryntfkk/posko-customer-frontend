        ...
        <div className="bg-white w-full max-w-5xl lg:rounded-3xl lg:shadow-2xl overflow-hidden flex flex-col lg:flex-row min-h-screen lg:min-h-[600px]">
            ...
            <div className="hidden lg:flex bg-red-600 text-white p-10 w-1/3 flex-col justify-between relative overflow-hidden">
                 ...
                 <div className="relative z-10">
                    <Link href="/" className="text-3xl font-extrabold tracking-tight hover:text-red-100 transition-colors">Posko.</Link>
                    <p className="text-red-100 mt-3 text-sm leading-relaxed opacity-90">Bergabunglah dengan ribuan pengguna dan temukan bantuan profesional dalam hitungan menit.</p>
                 </div>
            ...
            <div className="flex-1 flex flex-col h-full relative">
                ...
                <div className="lg:hidden bg-white px-6 pt-6 pb-4 sticky top-0 z-30 border-b border-gray-100 shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        <Link href="/" className="text-xl font-extrabold text-gray-900">Posko<span className="text-red-600">.</span></Link>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            ...
                            {step === 1 && (
                                <div className="space-y-6 animate-fadeIn">
                                    ...
                                    {/* Password - DIUBAH MENJADI FULL WIDTH (STACK) */}
                                    <div className="flex flex-col gap-2">
                                        <label className="label-text">Password</label>
                                        <input type="password" name="password" value={formData.password} onChange={handleChange} className="input-field" placeholder="Minimal 8 karakter"/>
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label className="label-text">Ulangi Password</label>
                                        <input type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} className="input-field" placeholder="Konfirmasi password"/>
                                    </div>
                                </div>
                            )}

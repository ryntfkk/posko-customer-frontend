...
export default function ProviderStickyBottomCTA({ provider }: ProviderStickyBottomCTAProps) {
  ...
  return (
    <div className="fixed bottom-20 left-0 right-0 p-4 bg-white border-t border-gray-200 lg:hidden z-40 flex items-center gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
